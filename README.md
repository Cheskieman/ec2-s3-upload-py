...
###  This project will display a PERFECT AND SIMPLE EXAMPLE on how to integrate a variety of WEB APPLICATIONS and have them all work in synchronization. In this project, we will be covering how to:

* Create  the neccasary IAM role and attach it to a newly created EC2 instance
* Create a custom Python file to upload to an EC2 instance
* Write additional lines of code in the EC2 instance to properly embed the custom Python file 
* Create the neccasary files in EC2 to then be stored in the S3 bucket
* Create an S3 bucket as well as a file that will store the information that we created with the Python file that we uploaded to the EC2 instance
